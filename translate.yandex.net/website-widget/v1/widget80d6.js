...
(function (win, doc, nav, params, namespace, undefined) {
    ...
    var initWidget = function () {
        util.loadScript('https://yastatic.net/s3/translate/v19.11.1/js/tr_page.js', wrapper, function () {
                ...
                function (responseText) {
                    ...
                    new Widget({
                        ...
                        translator: new namespace.PageTranslator({
                            srv: 'tr-url-widget',
                            sid: '5accaa27.5dde7f6a.9745df2d',
...
})(this, this.document, this.navigator, {"widgetTheme":"light","pageLang":"en","autoMode":"false","widgetId":"ytWidget"}, this.yt = this.yt || {});
